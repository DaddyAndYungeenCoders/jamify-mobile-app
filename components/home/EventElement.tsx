...
import { TouchableOpacity, StyleSheet, View, Image, Text, Alert, Modal, Button } from "react-native";
        ...
        <View>
            ...
            <TouchableOpacity style={[styles.container]} onPress={openDetail}>
                ...
                <View style={styles.overlay}>
                    <ThemedText style={styles.date}>{event.scheduledDate.toLocaleDateString()}</ThemedText>
                    ...
                    <View style={styles.bottomContainer}>
                        ...
                        <View style={styles.participantsContainer}>
                            <MaterialIcons name="people-outline" size={15} color="white" style={styles.icon} />
                            <ThemedText style={styles.participantsText}>{event.participants.length}</ThemedText>
                        </View>
                    </View>
