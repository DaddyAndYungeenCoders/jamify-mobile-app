...
const JamsBack: React.FC<JamProps> = ({ onRefresh }) => {
    const router = useRouter();
    const [isLoading, setIsLoading] = useState(false);
    const [jams, setJams] = useState<Jam[]>();

    const handleCreateJam = useCallback(() => {
        router.push({
            pathname: "/(details)/create-jam",
    ...
    return (
        <View style={styles.content}>
            <View style={styles.header}>
                ...
                <ClassicButton style={styles.newJam} title="NewJam" onPress={handleCreateJam}/>
            </View>
            <ScrollView
                horizontal={true}
